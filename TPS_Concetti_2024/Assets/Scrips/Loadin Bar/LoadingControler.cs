...
{
    private static LoadingControler instance;

    public float loadingProgress;
    private float timeLoading;
    private float fakeLoadTime = 2;

    public static event Action<LoadingControler> OnLoadingStart;
    public static event Action<LoadingControler> OnLoadingEnd;

    public static LoadingControler Get()
    {
        return instance;
    }
